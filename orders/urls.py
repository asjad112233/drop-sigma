...
urlpatterns = [
    ...
    path("api/<int:order_id>/notes/", views.order_notes_api, name="order_notes_api"),
    path("api/notes/<int:note_id>/", views.order_note_delete_api, name="order_note_delete_api"),
