...
urlpatterns = [
    ...
    # Live proxy/WAF debug — tells us exactly what curl_cffi does with the
    # configured WOO_PROXY_URL against a specific store. Superadmin only.
    path("api/<int:store_id>/proxy-test/", views.proxy_diagnostic_api, name="proxy_diagnostic_api"),
