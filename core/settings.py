...
MIDDLEWARE = [
    ...
    'superadmin.middleware.VisitTrackingMiddleware',
...
GROQ_API_KEY = os.getenv("GROQ_API_KEY")  # free tier — powers the in-app Support AI
...
EMAIL_USE_SSL  = True
EMAIL_USE_TLS  = False
EMAIL_TIMEOUT  = 10  # seconds — prevents SMTP from hanging the request
...
LOGGING = {
    ...
    "loggers": {
        "dropsigma.mail": {"handlers": ["console"], "level": "DEBUG", "propagate": False},
